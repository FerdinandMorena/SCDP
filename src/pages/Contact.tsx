  ...
  return (
    <div>
      <section className="relative bg-gray-900 text-white min-h-screen flex items-center">
        <div className="absolute inset-0 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1423666639041-f56000c27a9a?q=80&w=2074')" }}></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20">
          ...
          >
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto">
              Get in touch with us to learn more about our programs or to partner with us
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Whether you're interested in our programs, want to partner with us, or have questions, we're here to help.
            </p>
          </motion.div>
            ...
            {contactInfo.map((info, index) => (
              ...
              >
                ...
                <div className="p-8 text-center">
                  <div className={`${info.iconBg} w-16 h-16 rounded-full flex items-center justify-center mb-4 mx-auto group-hover:scale-110 transition-transform`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-green-600 to-blue-600 text-white py-4 rounded-lg font-semibold hover:from-green-700 hover:to-blue-700 transition-all transform hover:scale-105 flex items-center justify-center shadow-lg"
                >
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-800 mb-2">Join Our Programs</h4>
                    <p className="text-gray-600">Learn about our digital skills training and how you can enroll in our courses.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-800 mb-2">Partnership Opportunities</h4>
                    <p className="text-gray-600">Explore how your organization can partner with us to make an impact.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-800 mb-2">General Inquiries</h4>
                    <p className="text-gray-600">Have questions about our mission, programs, or impact? We're here to help.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Need assistance with our platform or courses? Our team is ready to support you.</p>
                  </div>
                </div>
              </div>

              <div className="mt-8 p-6 bg-white rounded-xl shadow-md">
                <h4 className="text-lg font-semibold text-gray-800 mb-3">Office Hours</h4>
